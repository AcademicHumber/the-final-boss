...
echo "<h2> $exito </h2>";
echo anchor("UserController/index", "¿Ya tienes una cuenta?");
echo "<br>";
?>
...
<table>
    ...
    <tr>
        ...
        <td><?php
            echo form_input("u[nombre_usuario]", "", ["required" => 1]);
    ...
    <tr>
        <td>Nombre</td>
        <td><?php
            echo form_input("u[nombre]", "", ["required" => 1]);
    ...
    <tr>
        <td>Apellido</td>
        <td><?php
            echo form_input("u[apellido]", "", ["required" => 1]);
