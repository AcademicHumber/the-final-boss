...
<table>
    ...
    <tr>
        ...
        <td><?php
            echo form_input("user[nombre_usuario]", $modificar["nombre_usuario"], ["required" => 1, "disabled"=>1]);            
    ...
    <tr>
        <td>Nombre</td>
        <td><?php
            echo form_input("user[nombre]", $modificar["nombre"], ["required" => 1]);
    ...
    <tr>
        <td>Apellido</td>
        <td><?php
            echo form_input("user[apellido]", $modificar["apellido"], ["required" => 1]);
    ...
    <tr>
        <td>Correo</td>
        <td><input type="email" name="user[correo]" value="<?php echo $modificar["correo"] ?>" required="1" disabled="1">
<?php
